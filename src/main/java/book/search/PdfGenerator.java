...
public class PdfGenerator {
    public static void generateBookListPdf(List<Book> books, String fileName) throws FileNotFoundException {
        ...
        Document document = new Document(pdf);  // com.itextpdf 라이브러리 사용
        document.setFontSize(12);
        // 폰트 생성 및 추가
        PdfFont font = null;
        try {
            font = PdfFontFactory.createFont("NANUMGOTHICLIGHT.TTF", PdfEncodings.IDENTITY_H, true);    // 사용할 폰트 지정
        ...
        // title 추가
        Paragraph titleParagraph = new Paragraph("도서 목록");  // com.itextpdf 라이브러리 사용
        ...
        // 도서 정보 테이블 생성
        Table table = new Table(UnitValue.createPointArray(new float[]{2, 2, 2, 2})); // com.itextpdf 라이브러리 사용
